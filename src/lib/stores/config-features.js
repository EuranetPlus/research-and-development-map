export const config = {
	mapTitle: 'research-and-development-map', // The title of the map, if more than one word, separate by dash, e.g. "income-europe"
	vercelURL: 'research-and-development-map.vercel.app', // The url provided when deploying the map on Vercel
	...
	colourScheme: 'orange-red', // one of the following: "blue", "purple-blue", "green-blue", "orange-red"
